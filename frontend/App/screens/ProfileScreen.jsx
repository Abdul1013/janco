  ...
  return (
    <SafeAreaView style={Typography.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        <Text style={Typography.buttonText}>Profile</Text>
      </TouchableOpacity>
      
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('JanitorRegistration')}>
          <Text style={styles.cardText}>Become a Janitor</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('History')}>
          <Text style={styles.cardText}>Service History</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card} onPress={() => alert('Support Contact')}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => alert('Coming soon')}>
          <Text style={styles.cardText}>Safety/Privacy</Text>
        </TouchableOpacity>
